...
<div class="container">
    <div class="headline flex-wr-sb-c breadcrumb-aera">
        <div class="f2-s-1 p-r-30 m-tb-6"> <a href="index.html" class="breadcrumb-item f1-s-3 cl9">Home</a> <span class="breadcrumb-item f1-s-3 cl9">Login</span></div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-content-box">
                        ...
                        <form>
                            ...
                            <div class="checkbox">
                                <div class="ez-checkbox pull-left">
                                    <label><input type="checkbox" class="ez-hide">Remember Me</label>
                                </div>
                                <a href="http://utouchdesign.com/themes/braksn_news/forgot-password.html" class="link-not-important pull-right">Forgot Password</a>
                    ...
                    <!-- Footer -->
                    <div class="footer"><span>Don't Have an Account? <a href="register.html">Register Here</a></span></div>
                </div>
                <!-- Form Box End -->
            </div>
        </div>
